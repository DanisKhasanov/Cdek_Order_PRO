...
var require_jquery_suggestions = __commonJS({
  "node_modules/suggestions-jquery/dist/js/jquery.suggestions.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(require_jquery()) : typeof define === "function" && define.amd ? define(["jquery"], factory) : factory(global.jQuery);
    })(exports, function($) {
      "use strict";
      ...
      var lang_util = {
        ...
        isPlainObject: function(obj) {
          if (obj === void 0 || typeof obj !== "object" || obj === null || obj.nodeType || obj === obj.window) {
            return false;
          }
      ...
      var object_util = {
        ...
        getDeepValue: function self(obj, name) {
          var path = name.split("."), step = path.shift();
      ...
      function sameParentChecker(preprocessFn) {
        return function(suggestions) {
          ...
          var parentValue = preprocessFn(suggestions[0].value), aliens = suggestions.filter(function(suggestion) {
            ...
            if (suggestions.length === 1) {
              if (fields) {
                collection_util.each(fields, function(stopwords, field) {
                  ...
                  var fieldWords = fieldValue && text_util.splitTokens(
              ...
              if (collection_util.minusWithPartialMatching(
                tokens,
                suggestionWords
              ).length === 0) {
                return 0;
      ...
      var ADDRESS_TYPE = {
        ...
        isDataComplete: function(suggestion) {
          var fields = [this.bounds.to || "flat"], data = suggestion.data;
          return !lang_util.isPlainObject(data) || object_util.fieldsAreNotEmpty(data, fields);
        },
        composeValue: function(data, options) {
          var country = data.country, region = data.region_with_type || collection_util.compact([data.region, data.region_type]).join(" ") || data.region_type_full, area = data.area_with_type || collection_util.compact([data.area_type, data.area]).join(" ") || data.area_type_full, city = data.city_with_type || collection_util.compact([data.city_type, data.city]).join(" ") || data.city_type_full, settelement = data.settlement_with_type || collection_util.compact([data.settlement_type, data.settlement]).join(" ") || data.settlement_type_full, cityDistrict = data.city_district_with_type || collection_util.compact([data.city_district_type, data.city_district]).join(" ") || data.city_district_type_full, street = data.street_with_type || collection_util.compact([data.street_type, data.street]).join(" ") || data.street_type_full, house = collection_util.compact([
            data.stead_type,
            data.stead,
            data.house_type,
            data.house,
            data.block_type,
            data.block
          ]).join(" "), flat = collection_util.compact([data.flat_type, data.flat]).join(" "), postal_box = data.postal_box && "а/я " + data.postal_box, result;
          if (region === city) {
            region = "";
          }
        ...
        formatResult: function() {
          var componentsUnderCityDistrict = [], _underCityDistrict = false;
          ...
          return function(value, currentValue, suggestion, options) {
            var that = this, district = suggestion.data && suggestion.data.city_district_with_type, unformattableTokens = options && options.unformattableTokens, historyValues = suggestion.data && suggestion.data.history_values, tokens, unusedTokens, formattedHistoryValues;
            ...
            if (district && (!that.bounds.own.length || that.bounds.own.indexOf("street") >= 0) && !lang_util.isEmptyObject(
        ...
        findUnusedTokens: function(tokens, value) {
          var tokenIndex, token, unused = [];
          unused = tokens.filter(function(token2) {
            return value.indexOf(token2) === -1;
          });
          return unused;
        },
        /**
        ...
        getFormattedHistoryValues: function(unusedTokens, historyValues) {
          var tokenIndex, token, historyValueIndex, historyValue, values = [], formatted = "";
          historyValues.forEach(function(historyValue2) {
            collection_util.each(unusedTokens, function(token2) {
              if (historyValue2.toLowerCase().indexOf(token2) >= 0) {
                values.push(historyValue2);
                return false;
              }
            });
          });
      ...
      var FIAS_TYPE = {
        ...
        unformattableTokens: ADDRESS_STOPWORDS,
        isDataComplete: function(suggestion) {
          var fields = [this.bounds.to || "house"], data = suggestion.data;
          return !lang_util.isPlainObject(data) || object_util.fieldsAreNotEmpty(data, fields);
        },
        composeValue: function(data, options) {
          var country = data.country, region = data.region_with_type || collection_util.compact([data.region, data.region_type]).join(" ") || data.region_type_full, area = data.area_with_type || collection_util.compact([data.area_type, data.area]).join(" ") || data.area_type_full, city = data.city_with_type || collection_util.compact([data.city_type, data.city]).join(" ") || data.city_type_full, settelement = data.settlement_with_type || collection_util.compact([data.settlement_type, data.settlement]).join(" ") || data.settlement_type_full, cityDistrict = data.city_district_with_type || collection_util.compact([data.city_district_type, data.city_district]).join(" ") || data.city_district_type_full, planning_structure = data.planning_structure_with_type || collection_util.compact([
            data.planning_structure_type,
            data.planning_structure
          ]).join(" ") || data.planning_structure_type_full, street = data.street_with_type || collection_util.compact([data.street_type, data.street]).join(" ") || data.street_type_full, house = collection_util.compact([
            data.house_type,
            data.house,
            data.block_type,
            data.block
        ...
        formatResult: /* @__PURE__ */ function() {
          return function(value, currentValue, suggestion, options) {
            var that = this;
            value = that.highlightMatches(
              value,
      ...
      function valueStartsWith(suggestion, field) {
        ...
        return fieldValue && new RegExp(
          "^" + text_util.escapeRegExChars(fieldValue) + "([" + WORD_DELIMITERS + "]|$)",
          "i"
      ...
      var NAME_TYPE = {
        ...
        isDataComplete: function(suggestion) {
          var that = this, params = that.options.params, data = suggestion.data, fields;
      ...
      function formattedField(main, alt, currentValue, suggestion, options) {
        var that = this, formattedMain = that.highlightMatches(
          main,
          currentValue,
          suggestion,
          options
      ...
      var PARTY_TYPE = {
        ...
        formatResult: function(value, currentValue, suggestion, options) {
          var that = this, formattedInn = that.type.formatResultInn.call(
            that,
            suggestion,
            currentValue
        ...
        formatResultInn: function(suggestion, currentValue) {
          var that = this, inn = suggestion.data && suggestion.data.inn, innPartsLength = innPartsLengths[suggestion.data && suggestion.data.type], innParts, formattedInn, rDigit = /\d/;
          if (inn) {
            formattedInn = that.highlightMatches(inn, currentValue, suggestion);
            if (innPartsLength) {
              formattedInn = formattedInn.split("");
              innParts = innPartsLength.map(function(partLength) {
                var formattedPart = "", ch;
              ...
              formattedInn = innParts.join(
                '<span class="' + that.classes.subtext_delimiter + '"></span>'
              ) + formattedInn.join("");
            }
            return formattedInn;
          }
      ...
      var BANK_TYPE = {
        ...
        geoEnabled: true,
        formatResult: function(value, currentValue, suggestion, options) {
          var that = this, formattedBIC = that.highlightMatches(
      ...
      Suggestions.prototype = {
        ...
        deferInitialization: function() {
          var that = this, events = "mouseover focus keydown", timer, callback = function() {
            that.initializer.resolve();
            that.enable();
          };
        ...
        notify: function(chainName) {
          var that = this, args = utils.slice(arguments, 1);
        ...
        onMousedown: function(e) {
          ...
          if ($(e.target).closest(".ui-menu-item").length == 0) {
            utils.delay(function() {
              $(document).one("mousedown", function(e2) {
                var $elements = that.el.add(that.$wrapper).add(that.options.$helpers);
                if (that.options.floating) {
                  $elements = $elements.add(that.$container);
                }
                $elements = $elements.filter(function() {
                  return this === e2.target || $.contains(this, e2.target);
                });
                if (!$elements.length) {
                  that.hide();
                }
        ...
        scrollToTop: function() {
          var that = this, scrollTarget = that.options.scrollOnFocus;
        ...
        clear: function() {
          var that = this, currentSelection = that.selection;
          if (that.isInitialized()) {
            that.clearCache();
            that.currentValue = "";
            that.selection = null;
        ...
        update: function() {
          var that = this, query = that.el.val();
          if (that.isInitialized()) {
         ...
         */
        fixData: function() {
          var that = this, fullQuery = that.extendedCurrentValue(), currentValue = that.el.val(), resolver = $.Deferred();
        ...
        extendedCurrentValue: function() {
          var that = this, parentInstance = that.getParentInstance(), parentValue = parentInstance && parentInstance.extendedCurrentValue(), currentValue = $.trim(that.el.val());
          return utils.compact([parentValue, currentValue]).join(" ");
        },
        getAjaxParams: function(method, custom) {
          var that = this, token = $.trim(that.options.token), partner = $.trim(that.options.partner), serviceUrl = that.options.serviceUrl, url = that.options.url, serviceMethod = serviceMethods[method], params = $.extend(
            {
        ...
        constructRequestParams: function(query, customParams) {
          var that = this, options = that.options, params = $.isFunction(options.params) ? options.params.call(that.element, query) : $.extend({}, options.params);
          ...
          if (response && $.isArray(response.suggestions)) {
            ...
            if (that.isBadQuery(query)) {
              ...
              if (!noCallbacks && options.onSearchStart.call(that.element, params) === false) {
                ...
                that.doGetSuggestions(params, method).done(function(response2) {
                  if (that.processResponse(response2) && query == that.currentValue) {
                    if (!options.noCache) {
                      if (useEnrichmentCache) {
                        that.enrichmentCache[query] = response2.suggestions[0];
                      } else {
                        that.enrichResponse(response2, query);
                        that.cachedResponse[cacheKey] = response2;
                        if (options.preventBadQueries && response2.suggestions.length === 0) {
                          that.badQueries.push(query);
                        }
                      }
                    }
                    resolver.resolve(response2.suggestions);
                  } else {
                    resolver.reject();
                  }
                  if (!noCallbacks) {
        ...
        getSuggestionValue: function(suggestion, selectionOptions) {
          var that = this, formatSelected = that.options.formatSelected || that.type.formatSelected, hasSameValues = selectionOptions && selectionOptions.hasSameValues, hasBeenEnriched = selectionOptions && selectionOptions.hasBeenEnriched, formattedValue, typeFormattedValue = null;
        ...
        setUnrestrictedValues: function(suggestions) {
          var that = this, shouldRestrict = that.shouldRestrictValues(), label = that.getFirstConstraintLabel();
      ...
      var methods = {
        ...
        onValueChange: function() {
          var that = this, currentSelection;
          if (that.selection) {
        ...
        isElementDisabled: function() {
          return Boolean(
            this.element.getAttribute("disabled") || this.element.getAttribute("readonly")
          );
        },
        isCursorAtEnd: function() {
          var that = this, valLength = that.el.val().length, selectionStart, range;
          try {
      ...
      var methods$1 = {
        checkStatus: function() {
          ...
          request.done(function(status, textStatus, request2) {
            if (status.search) {
              var plan = request2.getResponseHeader("X-Plan");
              status.plan = plan;
      ...
      var methods$2 = {
        checkLocation: function() {
          var that = this, providedLocation = that.options.geoLocation;
      ...
      var methods$3 = {
        enrichSuggestion: function(suggestion, selectionOptions) {
          var that = this, resolver = $.Deferred();
        ...
        enrichResponse: function(response, query) {
          var that = this, enrichedSuggestion = that.enrichmentCache[query];
      ...
      var methods$4 = {
        createContainer: function() {
          var that = this, suggestionSelector = "." + that.classes.suggestion, options = that.options, $container = $("<div/>").addClass(options.containerClass).css({
            display: "none"
          });
        ...
        setContainerOptions: function() {
          var that = this, mousedownEvent = "mousedown" + EVENT_NS;
        ...
        onSuggestionClick: function(e) {
          var that = this, $el = $(e.target), index;
        ...
        suggest: function() {
          var that = this, options = that.options, formatResult, html = [];
          ...
          if (!that.hasSuggestionsToChoose()) {
            if (that.suggestions.length) {
              ...
              if (noSuggestionsHint) {
                html.push(
                  '<div class="' + that.classes.hint + '">' + noSuggestionsHint + "</div>"
                );
              } else {
                that.hide();
                return;
            ...
            if (options.hint && that.suggestions.length) {
              html.push(
                '<div class="' + that.classes.hint + '">' + options.hint + "</div>"
              );
            }
            that.selectedIndex = -1;
        ...
        buildSuggestionHtml: function(suggestion, ordinal, html) {
          html.push(
            '<div class="' + this.classes.suggestion + '" data-index="' + ordinal + '">'
          );
          ...
          if (labels) {
            html.push(
              '<span class="' + this.classes.subtext_label + '">' + utils.escapeHtml(labels) + "</span>"
            );
          }
          html.push("</div>");
        },
        wrapFormattedValue: function(value, suggestion) {
          var that = this, status = utils.getDeepValue(suggestion.data, "state.status");
        ...
        highlightMatches: function(value, currentValue, suggestion, options) {
          var that = this, chunks = [], unformattableTokens = options && options.unformattableTokens, maxLength = options && options.maxLength, tokens, tokenMatchers, preferredTokens, rWords = utils.reWordExtractor(), match, word, i, chunk, formattedStr;
          if (!value) return "";
          tokens = text_util.tokenize(currentValue, unformattableTokens);
          tokenMatchers = $.map(tokens, function(token) {
            return new RegExp(
              "^((.*)([" + WORD_PARTS_DELIMITERS + "]+))?(" + utils.escapeRegExChars(token) + ")([^" + WORD_PARTS_DELIMITERS + "]*[" + WORD_PARTS_DELIMITERS + "]*)",
              "i"
            );
          });
          ...
          for (i = 0; i < chunks.length; i++) {
            ...
            if (chunk.matchable && !chunk.matched && ($.inArray(chunk.formatted, unformattableTokens) === -1 || chunk.hasUpperCase)) {
              $.each(tokenMatchers, function(j, matcher) {
                var tokenMatch = matcher.exec(chunk.formatted), length, nextIndex = i + 1;
                if (tokenMatch) {
                  tokenMatch = {
                    before: tokenMatch[1] || "",
        ...
        makeSuggestionLabel: function(suggestions, suggestion) {
          var that = this, fieldNames = that.type.fieldNames, nameData = {}, rWords = utils.reWordExtractor(), match, word, labels = [];
        ...
        activate: function(index) {
          var that = this, $activeItem, selected = that.classes.selected, $children;
          if (!that.dropdownDisabled) {
        ...
        adjustScroll: function(index) {
          var that = this, $activeItem = that.activate(index), itemTop, itemBottom, scrollTop = that.$container.scrollTop(), containerHeight;
      ...
      function belongsToArea(suggestion, instance) {
        var parentSuggestion = instance.selection, result = parentSuggestion && parentSuggestion.data && instance.bounds;
        if (result) {
      ...
      var ConstraintLocation = function(data, instance) {
        var that = this, fieldNames, fiasFieldNames, fiasFields = {};
      ...
      var Constraint = function(data, instance) {
        ...
        this.locations = locationsArray.map(function(data2) {
          return new ConstraintLocation(data2, instance);
        });
        this.locations = this.locations.filter(function(location2) {
          return location2.isValid();
        });
        this.label = data.label;
        if (this.label == null && instance.type.composeValue) {
          this.label = this.locations.map(function(location2) {
            return location2.getLabel();
          }).join(", ");
        }
      };
      jqapi.extend(Constraint.prototype, {
        ...
        getFields: function() {
          return this.locations.map(function(location2) {
            return location2.getFields();
          });
        }
      });
      var methods$5 = {
        ...
        setupConstraints: function() {
          var that = this, constraints = that.options.constraints, $parent;
          if (!constraints) {
        ...
        filteredLocation: function(data) {
          var locationComponents = [], location2 = {};
          ...
          if (!lang_util.isEmptyObject(location2)) {
            return location2.kladr_id ? { kladr_id: location2.kladr_id } : location2;
          }
        },
        ...
        constructConstraintsParams: function() {
          var that = this, locations = [], constraints = that.constraints, parentInstance, parentData, params = {};
          while (jqapi.isJqObject(constraints) && (parentInstance = constraints.suggestions()) && !(parentData = object_util.getDeepValue(
            parentInstance,
            "selection.data"
          ))) {
        ...
        getFirstConstraintLabel: function() {
          var that = this, constraints_id = lang_util.isPlainObject(that.constraints) && Object.keys(that.constraints)[0];
        ...
        unbindFromParent: function() {
          var that = this, $parent = that.constraints;
        ...
        getUnrestrictedData: function(data) {
          var that = this, restrictedKeys = [], unrestrictedData = {}, maxSpecificity = -1;
          collection_util.each(that.constraints, function(constraint, id) {
            collection_util.each(constraint.locations, function(location2, i) {
              if (location2.containsData(data) && location2.specificity > maxSpecificity) {
                maxSpecificity = location2.specificity;
              }
            });
          });
          if (maxSpecificity >= 0) {
      ...
      var methods$6 = {
        ...
        selectCurrentValue: function(selectionOptions) {
          var that = this, result = jqapi.Deferred();
          that.inputPhase.resolve();
        ...
        findSuggestionIndex: function() {
          var that = this, index = that.selectedIndex, value;
          if (index === -1) {
        ...
        select: function(index, selectionOptions) {
          var that = this, suggestion = that.suggestions[index], continueSelecting = selectionOptions && selectionOptions.continueSelecting, currentValue = that.currentValue, hasSameValues;
        ...
        trigger: function(event) {
          var that = this, args = utils.slice(arguments, 1), callback = that.options["on" + event];
      ...
      var methods$7 = {
        ...
        setBoundsOptions: function() {
          var that = this, boundsAvailable = [], newBounds = $.trim(that.options.bounds).split("-"), boundFrom = newBounds[0], boundTo = newBounds[newBounds.length - 1], boundsOwn = [], boundIsOwn, boundsAll = [];
        ...
        copyDataComponents: function(data, components) {
          var result = {}, dataComponentsById = this.type.dataComponentsById;
          if (dataComponentsById) {
            $.each(components, function(i, component) {
              $.each(dataComponentsById[component].fields, function(i2, field) {
                if (data[field] != null) {
        ...
        getBoundedKladrId: function(kladr_id, boundsRange) {
          var boundTo = boundsRange[boundsRange.length - 1], kladrFormat;
      ...
      $.fn.suggestions = function(options, args) {
        ...
        return this.each(function() {
          var inputElement = $(this), instance = inputElement.data(DATA_ATTR_KEY);
...
export default require_jquery_suggestions();
//# sourceMappingURL=suggestions-jquery.js.map
