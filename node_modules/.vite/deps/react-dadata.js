...
var makeRequest = function(method, endpoint, data, cache, onReceiveData) {
  ...
  xhr.onreadystatechange = function() {
    ...
    if (xhr.status === 200) {
      var payload = (_a2 = JSON.parse(xhr.response)) === null || _a2 === void 0 ? void 0 : _a2.suggestions;
      if (payload) {
      ...
      return import_react.default.createElement(
        ...
        optionsExpanded && import_react.default.createElement(
          ...
          suggestions.map(function(suggestion, index) {
            ...
            return import_react.default.createElement("button", { role: "option", type: "button", "aria-selected": index === suggestionIndex ? "true" : "false", key: _this.getSuggestionKey(suggestion), onMouseDown: _this.onSuggestionClick.bind(_this, index), className: suggestionClass }, _this.renderOption(suggestion));
          })
        ),
        children
      );
...
var BankSuggestions = (
  /** @class */
  function(_super) {
    __extends5(BankSuggestions2, _super);
      ...
      _this.renderOption = function(suggestion) {
        ...
        return renderOption ? renderOption(suggestion, query) : import_react4.default.createElement(
          ...
          import_react4.default.createElement(
            ...
            suggestion.data.bic && import_react4.default.createElement("div", { className: "react-dadata__suggestion-subtitle-item" }, suggestion.data.bic),
            ((_a = suggestion.data.address) === null || _a === void 0 ? void 0 : _a.value) && import_react4.default.createElement(
              "div",
...
var EmailSuggestions = (
  /** @class */
  function(_super) {
    __extends6(EmailSuggestions2, _super);
...
var PartySuggestions = (
  /** @class */
  function(_super) {
    __extends8(PartySuggestions2, _super);
      ...
      _this.renderOption = function(suggestion) {
        ...
        return renderOption ? renderOption(suggestion, query) : import_react7.default.createElement(
          ...
          import_react7.default.createElement(
            "div",
            { className: "react-dadata__suggestion-subtitle" },
            suggestion.data.inn && import_react7.default.createElement("div", { className: "react-dadata__suggestion-subtitle-item" }, suggestion.data.inn),
            ((_a = suggestion.data.address) === null || _a === void 0 ? void 0 : _a.value) && import_react7.default.createElement(
              "div",
              { className: "react-dadata__suggestion-subtitle-item" },
              import_react7.default.createElement(HighlightWords, { highlightClassName: highlightClassName || "react-dadata--highlighted", words: _this.getHighlightWords(), text: suggestion.data.address.value })
            )
          )
        );
      };
